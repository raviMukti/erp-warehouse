 ...
 * @author ravi
 */
public class EditKaryawanController implements Initializable {
    ...
    private void btnBatalAction(ActionEvent event) {
        ...
        alertBatal.setHeaderText("Batal Edit Karyawan");
        alertBatal.setContentText("Apakah anda yakin akan membatalkan perubahan karyawan?");
